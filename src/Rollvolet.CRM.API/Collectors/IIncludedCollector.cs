...
namespace Rollvolet.CRM.API.Collectors
{
    public interface IIncludedCollector
    {
        ...
        IEnumerable<IResource> CollectIncluded(IEnumerable<Offerline> offerlines, IncludeQuery includeQuery);
        ...
        IEnumerable<IResource> CollectIncluded(Invoiceline invoiceline, IncludeQuery includeQuery);
        IEnumerable<IResource> CollectIncluded(IEnumerable<Invoiceline> invoicelines, IncludeQuery includeQuery);
        ...
        IEnumerable<IResource> CollectIncluded(InvoiceSupplement invoiceSupplement, IncludeQuery includeQuery);
        IEnumerable<IResource> CollectIncluded(IEnumerable<InvoiceSupplement> invoiceSupplements, IncludeQuery includeQuery);
